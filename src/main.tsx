 ...
 */
/*
 * 線を引く 0.9秒（同時に絵の下地が立ち上がる）→ キャッチコピー →
 * 1.9秒から絵の主役 → 2.12秒で名前 → 4.4秒で本体へ渡す。
 *
 * **絵が見えている時間を 1.1秒から3.5秒に伸ばした。**
 * 直す前は 2.45秒から出て 3.6秒で消えていたので、咲ききる前に画面が
 * 変わっていた（本人指摘）。下地を印と同時に始めることで、
 * 待ち時間の増やしぶんを最小にしている。
 */
